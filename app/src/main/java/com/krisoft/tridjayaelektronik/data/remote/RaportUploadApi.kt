...
/**
 * Unggah bukti raport — SENGAJA dipisah dari [RaportApi].
 *
 * [RaportApi] memakai client bersama yang write/read timeout-nya 20 detik.
...
interface RaportUploadApi {
     ...
     * sepasang (lihat `ekstensiVideo`/`mimeVideo` di `RaportBuktiPlan.kt`).
     */
    @Multipart
