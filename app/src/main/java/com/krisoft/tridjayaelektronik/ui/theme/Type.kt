...
// Material Design 3 type scale, ported exactly from the Rhythm app reference
// (github.com/cromaguy/Rhythm). Rhythm ships a custom "Geom" font resource; here we
// keep FontFamily.Default (same scale, no bundled font asset required).
val TridjayaTypography = Typography(
