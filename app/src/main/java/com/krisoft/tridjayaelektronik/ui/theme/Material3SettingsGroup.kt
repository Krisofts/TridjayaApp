...
/**
 * Material 3 Expressive settings group, ported from Rhythm's `Material3SettingsGroup`
 * (github.com/cromaguy/Rhythm). A card stack with dynamic corner radii:
 *
 ...
 *
 * Simplified for this app: standard [ImageVector] icons, no streaming/local scope badges.
 */
@Composable
